...
const Navbar = () => {
  ...
  return (
    <div
      className=" fixed w-full h-[80px] flex justify-between z-20 items-center 
    ...
    >
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen color-background flex flex-col justify-center items-center"
        }
      >
